...
Available on CKAN as `TheGoldStandard`.
...
- Compatibility:  
  ...
  - [SCANsat Compatibility][thread:scnst]  
  - [Kopernicus][thread:kop]  
  - [Galileo's Planet Pack Compatibility][thread:gpp]  
  - and more...
...
- `Unobtainium` is denser than `Gold`, so ensure to bring adequate dΔÿ!
...
- Further Weight/Cost Balancing (see [discussion](https://github.com/zer0Kerbal/TheGoldStandard/discussions/14))  
...
#### Mods that benefit The Gold Standard!
...
- [x]  [Monero Flags (QBMF)][thread:QBMF]  
- [x]  [ISRU Thanks But No Tanks (KBTT)][thread:QBTT] 

- [x]  [Contract Configurator][thread:cc]  
- [x]  [Stockalike Mining Expansion (SMX)][thread:smx]  
- [x]  [Alternative Resource Panel][thread:arp]  
...
- [x]  [Stockalike Mining Expansion)][thread:smx]  
- [x]  [Kerbal Changelog][thread:kcl] 
...
###### v1.6.2.0 original: 01 Oct 2019 zed'K | updated: 15 Sep 2021 zed'K
...
[MOD:license]: https://github.com/zer0Kerbal/TheGoldStandard/blob/master/LICENSE "Github License"
[MOD:issues]:  https://github.com/zer0Kerbal/TheGoldStandard/wiki/Known-Issues "GitHub Issues"


[MOD:shld:latest]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/TheGoldStandard/master/json/mod.json

[CODE:shld]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/TheGoldStandard/master/json/code.json
...
<!--- misc logos -->
[IMG:flg:0]: https://raw.githubusercontent.com/zer0Kerbal/TheGoldStandard/master/img/TGS-Black.png "The Gold Standard Flag"

[IMG:hero:0]: https://raw.githubusercontent.com/zer0Kerbal/TheGoldStandard/master/img/HeroLogo_1920x1920%20(Large)_1.png "Hero"
[IMG:hero:0]: https:// "The Gold Standard"  
[IMG:hero:3]: https:// "The Gold Standard"  
