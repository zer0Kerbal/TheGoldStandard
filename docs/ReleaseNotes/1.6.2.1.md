...
### Correction
- `TheGoldStandard.version` had '-' instead of '_'; what is up with this graffiti? 
- Part [cost]
...
- `GoldSmelter.cfg`
  - [resourceOutputName = #autoLOC_8012033] changed to [#GoldSmelter-resourceOutputName =  Gold+Ore]
  - add small `Ore` tank
